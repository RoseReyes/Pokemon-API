...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getPokemon = function () {
        ...
        bulbasaur.subscribe(function (data) {
            ...
            var newApi = _this._http.get(data['abilities'][0]['ability']['url']);
            newApi.subscribe(function (newdata) {
                console.log('All Pokemon with Chlorophyll', newdata['pokemon'].length);
            });
        });
    };
...
module.exports = __webpack_require__(/*! /Users/rose/Desktop/DojoAssignments/MEAN/Angular/pokemonapi/Pokemon/src/main.ts */"./src/main.ts");
